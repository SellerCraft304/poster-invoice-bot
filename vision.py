...
1. СОВПАДЕНИЕ ТОЛЬКО ПО СМЫСЛУ ПРОДУКТА:
   - "Майонез 840г BOLBOL" → ищи ингредиент со словом "Майонез" → если найден, ставь его id
   - "Дрожжи 4×42г" → ищи "Дрожжи" → если найден, ставь id
   - Игнорируй граммовку, бренд, упаковку в названии товара

2. ЕСЛИ ПРОДУКТ НЕ НАЙДЕН В POSTER — ОБЯЗАТЕЛЬНО null:
   - "Рис жасмин" — если в списке Poster нет "Рис" или похожего → null
   - "Тостовый сыр" — если в Poster нет "Сыр тостовый" или "Сыр" → null
   - "Сыр кашар" — если в Poster нет "Кашар" или "Сыр кашар" → null
   - "Пакет для покупок" — если в Poster нет "Пакет", "Упаковка" → null
   - НИКОГДА не сопоставляй разные категории: Рис ≠ Салями, Сыр ≠ Соевый соус

3. КРИТЕРИЙ СОВПАДЕНИЯ: название ингредиента в Poster должно относиться к ТОМУ ЖЕ продукту.
   Если сомневаешься — ставь null. null лучше чем неправильный id.

4. НЕ придумывай id которых нет в списке выше.
"""
